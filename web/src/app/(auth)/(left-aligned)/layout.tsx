...
const AuthLeftAlignedLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <main className='grid h-full grid-cols-1 md:grid-cols-2'>
      <section className='flex items-end justify-center overflow-clip md:order-2'>
        <Image
      ...
      <section className='z-10 flex flex-col items-center justify-center gap-10 rounded-t-2xl bg-white p-14! text-center md:overflow-y-auto md:rounded-tl-none md:rounded-r-2xl md:p-8'>
